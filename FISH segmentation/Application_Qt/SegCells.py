...
"}")
        ...
        self.verticalGroupBox_2.setStyleSheet("#verticalGroupBox_2 {\n"
...
# Основная фун-я по сегментации:
    def predict_image(self):                     # ИСПРАВИТЬ: не допускать точности, ниже 0.2;
        if Ui_MainWindow.FILEPATH != '-1':       # Значит, что картинка была сохранена, путь есть;
            ...
            folder_path = '..\\Photo_Qt\\' + Ui_MainWindow.FILENAME  # Имя папки. If ниже проверяет, существует ли такая папка, есла да - удалить.
            ...
            predictions = model.predict(img, 
                                        ...
                                        name=Ui_MainWindow.FILENAME,  # model.predict сначала создасть папку с именем Ui_MainWindow.FILENAME (внутри папки project = ' '), только затем положит туда изображнеие с таким же названием, как и img; 
                                        show_labels = False, 
                                        show_conf = False,
            ...
            Path = '..\\Photo_Qt\\' + Ui_MainWindow.FILENAME + '\\' + Ui_MainWindow.FILENAME + '.jpg' # Берем путь, чтобы вывести на экран;
            pixmap = QPixmap(Path)
...
# фун-я, сохраняющая картинку:
    def FotoSave(self, pixmap, filename):
        ...
        Ui_MainWindow.FILENAME = Image_name
